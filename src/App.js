...
import {
  PostAespa,
  PostCat, PostCoinQuestion, PostDog,
  PostFactAboutWhale, PostGodOfWar,
  PostGreenSalad, PostHiringAd,
  PostHoodie,
  PostKryptonium,
  PostMelvin, PostNftArt, PostNftProjectAd, PostOhDuck, PostReadyPlayerOne,
  PostShipDuck, PostStayStrong, PostSummerWars, PostTeen, PostVitalik,
} from "./Posts";
